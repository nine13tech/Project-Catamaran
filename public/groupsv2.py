...
class GroupsV2(object):
    ...
    def get_members_of_group(self, group_id: int, current_page: int = 1) -> str:
        """GroupType: 0=General, 1=Clan"""
    ...
    def get_groups_for_member(self, membership_type: int, membership_id: int, search_filter: int, group_type: int) -> str:
    ...
    def get_potential_groups_for_member(self, membership_type: int, membership_id: int, search_filter: int, group_type: int) -> str:
